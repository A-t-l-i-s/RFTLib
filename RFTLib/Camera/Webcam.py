...
__all__=["RFT_Webcam","RFT_Webcam_Video","RFT_Webcam_Audio"]
...
class RFT_Webcam:
	...
	def __new__(cls,host:str,port:int,login:str=None,password:str=None):
		...
		self.videoCapture=RFT_Webcam_Video(self.videoHost)
		self.audioCapture=RFT_Webcam_Audio(self.audioHost)
